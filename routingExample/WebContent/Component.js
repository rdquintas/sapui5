...
com.tutorial.Component.prototype.init = function(){
	jQuery.sap.require("sap.ui.core.routing.History");//store history
	jQuery.sap.require("sap.m.routing.RouteMatchedHandler");//call a function while navigating
...
com.tutorial.Component.prototype.createContent = function(){
	this.view = sap.ui.view({id:"app",viewName:"sapui5tutorial1.App",type:sap.ui.core.mvc.ViewType.JS}); //instansiate view
	return this.view;
};